...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">ludoteca-austral-angular documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/DetalleJuego.html" data-type="entity-link" >DetalleJuego</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/JuegoCard.html" data-type="entity-link" >JuegoCard</a>
                            </li>
                            <li class="link">
